...
class GamePanel extends JPanel implements KeyListener {
    ...
    public GamePanel(JFrame j, JFrame minigameframe ,BoardGame Main ,BackgroundMusic2 bgm ) {
        ...
        Timer timer = new Timer(10, e -> {
            ...
            for (Obstacle obstacle : obstacles) {
                ...
                {
                	overcount +=1;
                    gameOver(1,minigameframe, j , Main ,bgm);
                ...
                {
                	overcount +=1;
                    gameOver(2,minigameframe, j , Main ,bgm);
                }
            }
    ...
    private void gameOver(int n, JFrame minigameframe, JFrame mainFrame,BoardGame Main ,BackgroundMusic2 bgm)  {
...
public class TwoPlayerObstacleGame {
    ...
    public void startGame(JFrame j, BoardGame Main) {
        ...
        frame.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_SPACE) {
                    ...
                    GamePanel gamePanel = new GamePanel(j,frame, Main,bgm);
                    frame.add(gamePanel);
                    frame.pack();
                    frame.revalidate();
