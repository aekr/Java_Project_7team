...
class GamePanel extends JPanel implements KeyListener {
    ...
    public GamePanel() {
        ...
        requestFocus();
        addKeyListener(this);
        backgroundImage = new ImageIcon(TwoPlayerObstacleGame.class.getResource("ex2.jpg")).getImage(); // 이미지 경로
        ...
        for (int i = 0; i < 5; i++) {
            ...
            obstacles.add(new Obstacle(random.nextInt(WIDTH + 40), -obstacleHeight + 20, 40, obstacleHeight, 15));
        }
...
public class TwoPlayerObstacleGame {
    public void startGame() {
        ...
        // 배경 이미지를 가진 패널 생성 및 추가
        BackgroundPanel backgroundPanel = new BackgroundPanel("ex2.jpg"); // 이미지 경로
...
//        gamestartLabel.setFont(new Font("HMKMRHD", Font.BOLD, 35));
